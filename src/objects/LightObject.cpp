...
LightObject::LightObject(double x_pos,double y_pos,double z_pos) {
	...
	qaLightPosition    = new GLfloat[4]{(float)x_pos, (float)y_pos, (float)z_pos, 1.0};
...
void LightObject::setLightPos(double x_pos, double y_pos, double z_pos) {
	this->disableLight();
	this->qaLightPosition    = new GLfloat[4]{(float)x_pos, (float)y_pos, (float)z_pos, 1.0};
...
void LightObject::setSpotDirection(double x_pos, double y_pos, double z_pos) {
	this->disableLight();
	this->spotDirection  = new GLfloat[4]{(float)x_pos,(float)y_pos,(float)z_pos,0.0};
}
